...
class TikiCachedContainer extends Container
{
    ...
    {
        require_once '/var/www/html/Zwiki/lib/tikiaccesslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/activity/activitylib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/admin/adminlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/perspective/binderlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/articles/artlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/attributes/attributelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/ajax/autosave.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/avatarlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/banners/bannerlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/bigbluebuttonlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/user/blacklistlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/blogs/bloglib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/cache/cachelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/calendar/calendarlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/captcha/captchalib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/payment/cartlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/categories/categlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/comments/commentslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/webmail/contactlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/contribution/contributionlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/credits/creditslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/crypt/cryptlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/csslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/dcs/dcslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/editlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/faqs/faqlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/search/federatedsearchlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/filegals/filegallib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/filegals/filegalbatchlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/flaggedrevisionlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/freetag/freetaglib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/geo/geolib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/goal/goallib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/goal/eventlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/goal/rewardlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/groupalert/groupalertlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/filegals/h5plib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/headerlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/histlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/theme/iconsetlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/imagegals/imagegallib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/videogals/kalturalib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/language/Language.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/language/LanguageTranslations.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/ldap/ldaplib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/loginlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/logs/logslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/logs/logsquerylib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/mailin/mailinlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/cache/memcachelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/menubuilder/menulib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/messu/messulib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/mime/mimelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/modules/modlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/user/monitorlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/user/monitormaillib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/multilingual/multilinguallib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/notifications/notificationlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/oauthlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/objectlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/rss/pagecontentlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/parser/parserlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/payment/paymentlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/perspectivelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/polls/polllib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/prefslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/quantifylib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/queuelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/quizzes/quizlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/rating/ratinglib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/rating/configlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/references/referenceslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/registration/registrationlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/attributes/relationlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/rss/rsslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/schedulerslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/score/scorelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/filegals/scormlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/search/searchstatslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/semanticlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/servicelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/sheet/sheetlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/init/smarty.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/user/sociallib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/stats/statslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/search/storedsearchlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/structures/structlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/templates/templateslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/theme/themelib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/theme/themecontrollib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/calendar/tikicalendarlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/todolib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/trackers/trackerlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/search/searchlib-unified.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/userslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/mailin/usermailinlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/usermodules/usermoduleslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/userprefs/userprefslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/validatorslib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/filegals/vimeolib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wiki/wikilib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/wizard/wizardlib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/ckeditor_tiki/wysiwyglib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/xmpp/xmpplib.php';
    ...
    {
        require_once '/var/www/html/Zwiki/lib/zoterolib.php';
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/Zwiki',
            'tiki.version' => '17.0',
        );
    }
}
