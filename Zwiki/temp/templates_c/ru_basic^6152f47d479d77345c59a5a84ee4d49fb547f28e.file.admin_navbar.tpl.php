<?php /* Smarty version Smarty-3.1.21, created on 2017-09-20 15:02:27
         compiled from "/var/www/html/Zwiki/templates/admin/admin_navbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80801603259c28303a2b1b0-17010882%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6152f47d479d77345c59a5a84ee4d49fb547f28e' => 
    array (
      0 => '/var/www/html/Zwiki/templates/admin/admin_navbar.tpl',
      1 => 1500735600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '80801603259c28303a2b1b0-17010882',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c28303a5cf39_56914331',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c28303a5cf39_56914331')) {function content_59c28303a5cf39_56914331($_smarty_tpl) {?><?php if (!is_callable('smarty_function_icon')) include '/var/www/html/Zwiki/lib/smarty_tiki/function.icon.php';
...
" value="advanced"<?php if ($_smarty_tpl->tpl_vars['pref_filters']->value['advanced']['selected']) {?> checked="checked"<?php }?>>
			...
			<ul class="nav navbar-nav filter-menu"<?php if (!$_smarty_tpl->tpl_vars['pref_filters']->value['advanced']['selected']) {?> style="display: none;"<?php }?>>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Настройки">
						<?php echo smarty_function_icon(array('name'=>"filter"),$_smarty_tpl);?>
 <span class="caret"></span>
					</a>
					<ul class="dropdown-menu" role="menu">
						<li><span class="dropdown-title">Любимые Фильтры</span></li>
...
if ($_smarty_tpl->tpl_vars['name']->value=='basic') {?> disabled="disabled"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['info']->value['label']);?>
							...
							<div class="text-center">
								<input type="submit" value="Установить по умолчанию" class="btn btn-primary btn-sm">
							</div>
...
" class="form-control" placeholder="Search preferences..." autofocus="autofocus">
					...
					<button type="submit" class="btn btn-default" <?php if ($_smarty_tpl->tpl_vars['indexNeedsRebuilding']->value) {?> class="tips" title="Поиск по конфигурации|Note: The search index needs rebuilding, this will take a few minutes."<?php }?>><?php echo smarty_function_icon(array('name'=>"search"),$_smarty_tpl);?>
</button>
				</form>
			</li>
		</ul>
...
?>
			...
			<div class="panel-footer text-center">
				<input class="btn btn-primary" type="submit" title="Apply Changes" value="Применить">
			</div>
