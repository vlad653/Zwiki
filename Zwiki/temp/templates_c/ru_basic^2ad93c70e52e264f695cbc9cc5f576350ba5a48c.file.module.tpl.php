<?php /* Smarty version Smarty-3.1.21, created on 2017-09-20 14:58:50
         compiled from "/var/www/html/Zwiki/templates/module.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134639550459c2822a8a1fa8-78774384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ad93c70e52e264f695cbc9cc5f576350ba5a48c' => 
    array (
      0 => '/var/www/html/Zwiki/templates/module.tpl',
      1 => 1490351219,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134639550459c2822a8a1fa8-78774384',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2822a8d3a60_48811597',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2822a8d3a60_48811597')) {function content_59c2822a8d3a60_48811597($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/Zwiki/vendor_bundled/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
" class="">
					...
					<?php if ($_smarty_tpl->tpl_vars['module_error']->value) {?>
						<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"warning",'title'=>"Ошибка")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Ошибка"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

						<?php echo $_smarty_tpl->tpl_vars['module_error']->value;?>

						<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>"warning",'title'=>"Ошибка"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">
								<?php echo smarty_function_icon(array('name'=>"up",'alt'=>"Выше"),$_smarty_tpl);?>
...
">
								<?php echo smarty_function_icon(array('name'=>"down",'alt'=>"Ниже"),$_smarty_tpl);?>
...
"
								...
								<?php echo smarty_function_icon(array('name'=>"remove",'alt'=>"снять назначение"),$_smarty_tpl);?>
