<?php /* Smarty version Smarty-3.1.21, created on 2017-09-20 15:08:29
         compiled from "/var/www/html/Zwiki/templates/admin/include_profiles.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175562920459c2846dc0a523-42837239%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8c93eddd90303d302c52d835f1a894208ddb3d1' => 
    array (
      0 => '/var/www/html/Zwiki/templates/admin/include_profiles.tpl',
      1 => 1495536458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '175562920459c2846dc0a523-42837239',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2846dc70563_77172633',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2846dc70563_77172633')) {function content_59c2846dc70563_77172633($_smarty_tpl) {?><?php if (!is_callable('smarty_block_jq')) include '/var/www/html/Zwiki/lib/smarty_tiki/block.jq.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('tabset', array('name'=>'tabs_admin-profiles')); $_block_repeat=true; echo smarty_block_tabset(array('name'=>'tabs_admin-profiles'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
	...
	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Применить")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Применить"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="profile" placeholder="Найти..." id="profile" value="<?php if (isset($_smarty_tpl->tpl_vars['profile']->value)) {
...
"<?php if (isset($_smarty_tpl->tpl_vars['repository']->value)&&$_smarty_tpl->tpl_vars['repository']->value==$_smarty_tpl->tpl_vars['source']->value['url']) {?> selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['source']->value['short']);?>
						...
						<div class="form-group text-center">
							<input type="submit" class="btn btn-primary timeout" name="list" value="Найти" />
						</div>
					</div>
					<div class="col-sm-6">
...
' )"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['profile']->value['name']);?>
						...
						<?php if (count($_smarty_tpl->tpl_vars['result']->value)=='0') {?>
							<tr><td colspan="3" class="odd">Ничего</td></tr>
						<?php }?>
					</table>
...
');<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_jq(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
		...
		<?php }?>
	<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tab(array('name'=>"Применить"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>


	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Экспорт")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Экспорт"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
 ...
 :
					...
					<div class="text-center submit input_submit_container">
						<input type="submit" class="btn btn-primary timeout" name="export" value="Экспорт" />
					</div>
				</fieldset>
			</fieldset>
		</form>
	<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tab(array('name'=>"Экспорт"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>


	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Продвинутый")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Продвинутый"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
							<?php if ($_smarty_tpl->tpl_vars['entry']->value['status']=='open') {?>
								<?php echo smarty_function_icon(array('name'=>'status-open','iclass'=>'tips','ititle'=>"Статус:Открыт"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','istyle'=>'display:none','iclass'=>'tips','ititle'=>"Статус:На рассмотрении"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-closed','istyle'=>'display:none','iclass'=>'tips','ititle'=>"Статус:Закрыт"),$_smarty_tpl);?>

							<?php } elseif ($_smarty_tpl->tpl_vars['entry']->value['status']=='closed') {?>
								<?php echo smarty_function_icon(array('name'=>'status-open','istyle'=>'display:none','iclass'=>'tips','ititle'=>"Статус:Открыт"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','istyle'=>'display:none','iclass'=>'tips','ititle'=>"Статус:На рассмотрении"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-closed','iclass'=>'tips','ititle'=>"Статус:Закрыт"),$_smarty_tpl);?>

							<?php } else { ?>
								<?php echo smarty_function_icon(array('name'=>'status-open','istyle'=>'display:none','iclass'=>'tips','ititle'=>"Статус:Открыт"),$_smarty_tpl);?>

								<?php echo smarty_function_icon(array('name'=>'status-pending','iclass'=>'tips','ititle'=>"Статус:На рассмотрении"),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['entry']->value['formatted'];?>
...
)" title="Обновить"><?php echo smarty_function_icon(array('name'=>"refresh",'iclass'=>'tips','ititle'=>":Обновить"),$_smarty_tpl);?>
</a></td>
					</tr>
				<?php } ?>
			</table>
			<form class="form-horizontal" action="tiki-admin.php?page=profiles" method="post">
				...
				<div class="text-center submit">
					<input type="submit" class="btn btn-primary timeout" name="config" value="Сохранить" />
				</div>
			</form>
		</fieldset>
...
echo $_smarty_tpl->tpl_vars['profile_tester_name']->value;
						...
						<div class="col-sm-4">
							...
							<option value=""<?php if (isset($_smarty_tpl->tpl_vars['empty_cache']->value)&&$_smarty_tpl->tpl_vars['empty_cache']->value=='') {?> checked="checked"<?php }?>>Ничего</option>
							<option value="all"<?php if (isset($_smarty_tpl->tpl_vars['empty_cache']->value)&&$_smarty_tpl->tpl_vars['empty_cache']->value=='all') {?> checked="checked"<?php }?>>Все</option>
...
echo $_smarty_tpl->tpl_vars['test_source']->value;
				...
				<div align="center" style="padding:1em;"><input type="submit" class="btn btn-default timeout" name="test" value="Тест"></div>
			</form>
		</fieldset>
	<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tab(array('name'=>"Продвинутый"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
