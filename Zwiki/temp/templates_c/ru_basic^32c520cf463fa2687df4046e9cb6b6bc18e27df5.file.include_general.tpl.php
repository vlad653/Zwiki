<?php /* Smarty version Smarty-3.1.21, created on 2017-09-20 15:02:34
         compiled from "/var/www/html/Zwiki/templates/admin/include_general.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8531961759c2830a34f1e2-87814126%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32c520cf463fa2687df4046e9cb6b6bc18e27df5' => 
    array (
      0 => '/var/www/html/Zwiki/templates/admin/include_general.tpl',
      1 => 1492791516,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8531961759c2830a34f1e2-87814126',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2830a3c3be7_14905569',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2830a3c3be7_14905569')) {function content_59c2830a3c3be7_14905569($_smarty_tpl) {?><?php if (!is_callable('smarty_function_button')) include '/var/www/html/Zwiki/lib/smarty_tiki/function.button.php';
...
if (!is_callable('smarty_modifier_tiki_long_date')) include '/var/www/html/Zwiki/lib/smarty_tiki/modifier.tiki_long_date.php';
...
<form class="form-horizontal" action="tiki-admin.php?page=general" class="admin" method="post">
	...
	<div class="t_navbar margin-bottom-md">
		<?php echo smarty_function_button(array('_class'=>"btn btn-link tips",'_type'=>"text",'href'=>"tiki-install.php",'_icon_name'=>"database",'_text'=>"Tiki installer",'_title'=>":Сбросить или обновить базу данных"),$_smarty_tpl);?>

		<?php echo smarty_function_button(array('_class'=>"btn btn-link tips",'_type'=>"text",'href'=>"tiki-admin_menus.php",'_icon_name'=>"menu",'_text'=>"Меню",'_title'=>":Create and edit menus"),$_smarty_tpl);?>

		<?php echo smarty_function_button(array('_class'=>"btn btn-link tips",'_type'=>"text",'href'=>"tiki-admin.php?page=general&amp;forcecheck=1",'_icon_name'=>"search",'_text'=>"Проверить обновления сейчас",'_title'=>":Проверить обновления сейчас"),$_smarty_tpl);?>
	...
	<?php $_smarty_tpl->smarty->_tag_stack[] = array('tabset', array('name'=>"admin_general")); $_block_repeat=true; echo smarty_block_tabset(array('name'=>"admin_general"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
		...
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Основные настройки")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Основные настройки"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
			...
			<fieldset>
				...
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"info",'title'=>"Тики версия",'close'=>"n")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"info",'title'=>"Тики версия",'close'=>"n"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

					<?php if (!empty($_smarty_tpl->tpl_vars['lastup']->value)) {?>
						Последнее обновление из SVN (<?php echo $_smarty_tpl->tpl_vars['tiki_version']->value;?>
				...
				<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>"info",'title'=>"Тики версия",'close'=>"n"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
		...
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Navigation")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Navigation"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
			...
			<fieldset>
				...
				<div class="adminoptionboxchild" id="namespace_enabled_childcontainer">
					...
					<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"note",'title'=>"Информация")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"note",'title'=>"Информация"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
					...
					<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>"note",'title'=>"Информация"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
		...
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('tab', array('name'=>"Date and Time")); $_block_repeat=true; echo smarty_block_tab(array('name'=>"Date and Time"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
			...
			<?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>"info",'title'=>"php.net")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>"info",'title'=>"php.net"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
				...
				<a class="alert-link" href="http://www.php.net/manual/en/function.strftime.php">
					Справка о формате даты и времени
				</a>
			...
			<fieldset>
				...
				<div class="clearfix">
					...
					Пример: <?php echo smarty_modifier_tiki_long_date($_smarty_tpl->tpl_vars['now']->value);?>
				...
				<div class="clearfix">
					...
					<span class="help-block col-md-8 col-md-push-4">
					Пример: <?php echo smarty_modifier_tiki_short_date($_smarty_tpl->tpl_vars['now']->value);?>
				...
				<div class="clearfix">
					...
					<span class="help-block col-md-8 col-md-push-4">
					Пример: <?php echo smarty_modifier_tiki_long_time($_smarty_tpl->tpl_vars['now']->value);?>
				...
				<div class="clearfix">
					...
					<span class="help-block col-md-8 col-md-push-4">
					Пример: <?php echo smarty_modifier_tiki_short_time($_smarty_tpl->tpl_vars['now']->value);?>
