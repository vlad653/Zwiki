<?php /* Smarty version Smarty-3.1.21, created on 2017-09-19 15:59:22
         compiled from "/var/www/html/Zwiki/templates/footer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:112382764459c13edaa63f37-86563923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5564237cfc8145f9cabc2e26b76ca6c4efe0bd3f' => 
    array (
      0 => '/var/www/html/Zwiki/templates/footer.tpl',
      1 => 1491138129,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '112382764459c13edaa63f37-86563923',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c13edaa91863_17347151',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c13edaa91863_17347151')) {function content_59c13edaa91863_17347151($_smarty_tpl) {?><?php if (!is_callable('smarty_block_remarksbox')) include '/var/www/html/Zwiki/lib/smarty_tiki/block.remarksbox.php';
...
if (!is_callable('smarty_function_debugger')) include '/var/www/html/Zwiki/lib/smarty_tiki/function.debugger.php';
if (!is_callable('smarty_block_wikiplugin')) include '/var/www/html/Zwiki/lib/smarty_tiki/block.wikiplugin.php';
if (!is_callable('smarty_function_interactivetranslation')) include '/var/www/html/Zwiki/lib/smarty_tiki/function.interactivetranslation.php';
?>
...
<?php if ((!isset($_smarty_tpl->tpl_vars['display']->value)||$_smarty_tpl->tpl_vars['display']->value=='')) {?>
	...
	<div class="container<?php if (isset($_SESSION['fullscreen'])&&$_SESSION['fullscreen']=='y') {?>-fluid<?php }?>">
		<?php echo smarty_function_button(array('_ajax'=>"n",'_id'=>"show-errors-button",'_onclick'=>"flip('errors');return false;",'_text'=>"Показать ошибки php"),$_smarty_tpl);?>
