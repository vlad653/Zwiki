<?php /* Smarty version Smarty-3.1.21, created on 2017-09-20 14:58:50
         compiled from "/var/www/html/Zwiki/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:155774028459c2822a789986-89534196%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11e2a40a5d990744b730b0ceea30c476e6029211' => 
    array (
      0 => '/var/www/html/Zwiki/templates/header.tpl',
      1 => 1492793092,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '155774028459c2822a789986-89534196',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2822a85c311_25932744',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2822a85c311_25932744')) {function content_59c2822a85c311_25932744($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/Zwiki/lib/smarty_tiki/modifier.truncate.php';
...
<?php if (!empty($_smarty_tpl->tpl_vars['forum_info']->value['name'])&$_smarty_tpl->tpl_vars['prefs']->value['metatag_threadtitle']=='y') {?>
	<meta name="keywords" content="Форум <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['forum_info']->value['name']);?>
...
<?php } elseif (isset($_smarty_tpl->tpl_vars['galleryId']->value)&&$_smarty_tpl->tpl_vars['galleryId']->value!=''&&$_smarty_tpl->tpl_vars['prefs']->value['metatag_imagetitle']!='n') {?>
	<meta name="keywords" content="Галереи изображений <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['title']->value);?>
 <?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_freetags']=='y') {
$_smarty_tpl->tpl_vars['taginfo'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['taginfo']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['freetags']->value['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['taginfo']->key => $_smarty_tpl->tpl_vars['taginfo']->value) {
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['ix']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['ix']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['ix']['total']);
ob_start();?><?php echo $_smarty_tpl->tpl_vars['structure_path']->value[$_smarty_tpl->getVariable('smarty')->value['section']['ix']['index']]['page_alias'];?>
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["aliasname"] = new Smarty_variable($_tmp9, null, 0);
endfor; endif;
}
if (!empty($_smarty_tpl->tpl_vars['page_description_title']->value)) {
echo $_smarty_tpl->tpl_vars['page_description_title']->value;
...
<?php if ((isset($_smarty_tpl->tpl_vars['editable']->value)&&$_smarty_tpl->tpl_vars['editable']->value)&&($_smarty_tpl->tpl_vars['tiki_p_edit']->value=='y'||mb_strtolower($_smarty_tpl->tpl_vars['page']->value, 'UTF-8')=='sandbox'||$_smarty_tpl->tpl_vars['tiki_p_admin_wiki']->value=='y')) {?>
	<link rel="alternate" type="application/x-wiki" title="Правка!" href="tiki-editpage.php?page=<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['page']->value,'url');?>
">
<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_wiki']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_wiki']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_wiki_title']))===null||$tmp==='' ? "RSS вики" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_blogs']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_blogs']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_read_blog']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_blogs_title']))===null||$tmp==='' ? "RSS блогов" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_articles']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_articles']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_read_article']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_articles_title']))===null||$tmp==='' ? "RSS статей" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_galleries']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_image_galleries']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_image_gallery']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_image_galleries_title']))===null||$tmp==='' ? "RSS галерей изображений" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_file_galleries']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_file_galleries']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_file_gallery']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_file_galleries_title']))===null||$tmp==='' ? "RSS файловых галерей" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_forums']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_forums']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_forum_read']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_forums_title']))===null||$tmp==='' ? "RSS форумов" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_directory']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_directories']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_directory']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_directories_title']))===null||$tmp==='' ? "RSS директорий" : $tmp);?>
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_calendar']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feed_calendar']=='y'&&$_smarty_tpl->tpl_vars['tiki_p_view_calendar']->value=='y') {?>
	<link rel="alternate" type="application/rss+xml" title='<?php echo (($tmp = @smarty_modifier_escape($_smarty_tpl->tpl_vars['prefs']->value['feed_calendar_title']))===null||$tmp==='' ? "RSS календарей" : $tmp);?>
