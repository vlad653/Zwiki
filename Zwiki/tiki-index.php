...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="//localhost">Zwiki</a>
    </div>
      ...
      <ul class="nav navbar-nav">
	   ...
	   <li role="presentation" class="dropdown-header">Формула связи</li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="http://localhost/Zwiki/tiki-index.php?page=%D0%9F%D1%80%D0%BE%D1%88%D0%B8%D0%B2%D0%BA%D0%B0">Прошивка</a></li>
